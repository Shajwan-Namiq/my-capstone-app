  ...
  return (
    <>
      <div class="container mx-auto ">
        <div class="flex shadow-md  first-letter:">
            ...
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
              <div class="flex w-2/4">
                ...
                <div class="flex flex-col justify-between ml-4 flex-grow">
                  <span class="font-bold text-sm"> name : {name}</span>
                  <span class="font-bold  text-xs">company name :</span>
                </div>
              </div>

              <div class="lg:mr-7 flex justify-center w-1/4">
              ...
              <span class="lg:mr-7  text-center w-1/5 font-semibold text-sm">
                $ {price}
              </span>
